...
class Forms:
    def ShowLoginForm():
        ...
        MidLoginForm = customtkinter.CTkFrame(loginform, width=300)
    ...
    def ShowAddNew():
        ...
        # Frames
        TopAddNew = customtkinter.CTkFrame(addnewform, width=600, height=100, bd=2)
        TopAddNew.pack(side=TOP, pady=15)
        MidAddNew = customtkinter.CTkFrame(addnewform, width=600, bg='#006400')
    ...
    def ShowEdit():
        ...
        MidEditNew = customtkinter.CTkFrame(editform, width=600, bg='#006400')
    ...
    def ShowView():
        ...
        switch.pack(side=TOP, padx=10, pady=10, fill=X)  # change padding
        tree.pack()
